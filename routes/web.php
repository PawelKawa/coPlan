...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::match(['get', 'post'],'/finder/tags/{name}', [FinderItemsController::class, 'sortByTags'])->name('finder.tags'); // not posting/saving anything, just using post so to url is passed only name and to backend id
